...
from lading.commands import publish_pipeline
...
def test_invoke_logs_command_with_cwd(
    ...
    exit_code, stdout, stderr = publish_pipeline._invoke(
...
def test_invoke_logs_command_without_cwd(
    ...
    exit_code, stdout, stderr = publish_pipeline._invoke(("echo", "hello"))
...
"""
    ...
    exit_code, stdout, stderr = publish_pipeline._invoke((sys.executable, "-c", script))
